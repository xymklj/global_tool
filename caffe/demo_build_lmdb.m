...
% %for center loss
% tools='/home/scw4750/github/caffe/build/tools/convert_imageset';
% list_txt='train_test_list/center_list_for_train/cylindrical_list.txt';
% data_root='/home/scw4750/github/IJCB2017/liufeng/train/lightcnn/train_test_data';
% resize_height=144;
% resize_width=144;
% gray='true';
% output_name='lmdb/centerloss_lmdb';
% 
% 
...
% 
% system([tools ' --resize_height ' num2str(resize_height) ' --resize_width ' ...
%     num2str(resize_width) ' --gray=' gray ' --shuffle=true ' data_root filesep ' ' ...
